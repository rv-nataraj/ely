...
?>
  ...
  <div id="content-wrapper">
          ...
          <!-- Icon Cards-->
          <div class="container">
          <center><h3 style="color:white;background-color:blue;font-size:200%;"><b>COMPLAINTS HISTORY</b></h3></center>
           <br>
...
$sql = "SELECT * from complaint where LOWER(district) =LOWER('$district') and LOWER(state) =LOWER('$state') and police_id='$id' AND status='finished' or status='decline'";
//Prepare the query:
