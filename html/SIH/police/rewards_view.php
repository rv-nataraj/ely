...
?>
  ...
  <head>
    ...
    <title> Police - Rewards view</title>
...
<center><h3 style="color:white;background-color:blue;font-size:150%;"><b>REWARDS DETAILS VIEW</b></h3></center>
           <br>
  </div>
<article class="card-body " style="max-width: 400px;">
            ...
            <div class="form-group">
                    ...
                    <div class="col">
                        <input type="text"  value="<?php echo htmlentities($result->Complainant_id);?>" class="form-control">
                    </div>
                </div>     
                <div class="form-group">
                ...
                <a href="rewards_history.php" class="btn btn-primary btn-danger">Back</a>
                </center>
