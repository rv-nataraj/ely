...
?>
  ...
  <head>
    ...
    <title> Police - Rewards ADD</title>
  ...
  <div id="content-wrapper">
          ...
          <!-- Icon Cards-->
          <div class="container">
          <center><h3 style="color:white;background-color:blue;font-size:200%;"><b>REWARD ADD</b></h3></center>
           <br>
...
$sql = "SELECT * from complaint where police_id='$id' AND status='finished' and reward_id is NULL;";
//Prepare the query:
...
?>  
        ...
        <tbody>
            <tr>
                ...
                <td><a href="add_reward.php?id=<?php echo htmlentities($result->id);?>"><button type="button" class="btn btn-success btn-xs" ><span class="fa fa-plus"></span></button></a></td>
