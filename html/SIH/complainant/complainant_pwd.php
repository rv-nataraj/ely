...
if(isset($_POST['update']))
{
    ...
    $sql="UPDATE `users` SET `password`='$newpwd' WHERE username='$user' AND password='$oldpwd' and user_type='complainant';";
...
?>
  ...
  <div id="content-wrapper">
      ...
      <div class="card card-login mx-auto mt-5 border border-success">
      <div class="card-header text-center">Password change</div>
        ...
        <form name="insertrecord" method="post">
            ...
            <a href="complainant.php" type="button" class="btn btn-info text-white" name="update" >back</a></center>
          </form>
        </div>
      </div>
    </div>
