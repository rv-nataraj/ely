...
?>
  <head>
    ...
    <title> complainant - Complaintview</title>
...
<article class="card-body" style="max-width: 400px;">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                    <input type="text"  name="sprice" value="<?php echo htmlentities($result->product_details);?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="phoneNumber" class="col">Victim number</label>
                    <div class="col">
                ...
                <div class="form-group">
                    <label for="phoneNumber" class="col">Police ID</label>
                    <div class="col">
                        <input type="phoneNumber"  name="vnum" value="<?php echo htmlentities($result->police_id);?>" class="form-control">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col">
                    <div class=" text-white text-md-center h-25 bg-success" style="width: 10rem;">
                    <center><?php echo htmlentities($result->status);?></center>
                     </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="phoneNumber" class="col">Police discription</label>
                    <div class="col">
                        <input type="phoneNumber"  name="vnum" value="<?php echo htmlentities($result->status_des);?>" class="form-control">
               ...
               <center><mark style="color:black;background-color:#00cc00;" ><b>NO AUDIO</b></mark></center>
                ...
                <br>
                <center>                
                <a href="complainant.php" class="btn btn-primary btn-secondary border border-danger">Back</a>
                </center>
            </form> <!-- /form -->
        </div> <!-- ./container -->
</article>
