...
<a class="navbar-brand  mr-1 text-white font-weight-bold" href="complainant.php"><img src="img/1.png" width="40" height="40" class="img-rounded" alt=""></img><?php echo strtoupper($_SESSION['user']['name']); ?></a>
...
<ul class="navbar-nav ml-auto ml-md-0 ">
  ...
  <li class="nav-item dropdown no-arrow fa-lg ">
    ...
    <a class="dropdown-item" href="complainant_profile.php"><i class="far fa-user-circle fa-lg"></i> &nbsp;Profile</a>
    <div class="dropdown-divider"></div>
      <a class="dropdown-item" href="complainant_pwd.php"><i class="fa fa-key fa-lg"></i> &nbsp;password reset</a>
